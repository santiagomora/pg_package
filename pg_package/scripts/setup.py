import psycopg
import pg_package.scripts._common as cm
import argparse
import sys
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        description='Initizalizes migration tables when pg_package is first installed',
        epilog='')
    ...
    try:
        cm.check_pg_package_installed_correctly(config)
        cm.prompt_error('pg_package set up correctly. Exiting ...')
        exit(1)
