...
PG_CPP_TABLE_DECLARATION(CORE_PG_MIGRATIONS_DB_EXECUTION_COMMIT_HASH);
...
PG_CPP_INVOKABLE_DECLARATION(CORE_PG_MIGRATIONS_DB_REGISTER_EXECUTION_COMMIT_HASH);
...
IFACE_CPP_CLASSDEF_DECLARATION(CORE_PG_MIGRATIONS_DB_EXECUTION_COMMIT_HASH);
...
PG_DECLARE_TABLE_CONVERSION(CORE_PG_MIGRATIONS_DB_EXECUTION_COMMIT_HASH);
