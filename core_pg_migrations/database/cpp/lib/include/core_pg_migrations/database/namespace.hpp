...
struct package_procedure_schema_exists
: public pg::queries_database_on_transaction<
    package_procedure_schema_exists,
    pg::fetch_one_functor,
...
struct register_migration_dependencies
: public pg::queries_database_on_transaction<
    register_migration_dependencies,
    ...
    pg::NoResult_>
{
    static constexpr const std::string_view query_string (
        ...
        return "SELECT register_migration_dependencies (\
            p_migration        := $1,\
...
PG_CPP_INVOKABLE_DECLARATION(CORE_PG_MIGRATIONS_DB_REGISTER_MIGRATION_DEPENDENCIES);
