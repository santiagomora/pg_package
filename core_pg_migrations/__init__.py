# BEGIN
# RAISE NOTICE 'EXECUTING MIGRATION create_core_pg_migrations_schema';
# CREATE SCHEMA "core_migrations";
# EXCEPTION WHEN OTHERS THEN
# RAISE NOTICE 'MIGRATION create_core_pg_migrations_schema ERROR';
...
# 
# BEGIN
# RAISE NOTICE 'EXECUTING MIGRATION create_core_pg_migrations_package_table';
...
# EXCEPTION WHEN OTHERS THEN
# RAISE NOTICE 'MIGRATION create_core_pg_migrations_package_table ERROR';
# RAISE NOTICE 'STATE: %s, ERROR: %s.', SQLSTATE, SQLERRM;
# RAISE NOTICE 'ROLLING BACK...';
# ROLLBACK;
# END;
...
# 
# BEGIN
# RAISE NOTICE 'EXECUTING MIGRATION create_core_pg_migrations_migration_table';
...
# EXCEPTION WHEN OTHERS THEN
# RAISE NOTICE 'MIGRATION create_core_pg_migrations_migration_table ERROR';
# RAISE NOTICE 'STATE: %s, ERROR: %s.', SQLSTATE, SQLERRM;
# RAISE NOTICE 'ROLLING BACK...';
# ROLLBACK;
# END;
...
# 
# BEGIN
# RAISE NOTICE 'EXECUTING MIGRATION create_core_pg_migrations_execution_table';
...
# EXCEPTION WHEN OTHERS THEN
# RAISE NOTICE 'MIGRATION create_core_pg_migrations_execution_table ERROR';
# RAISE NOTICE 'STATE: %s, ERROR: %s.', SQLSTATE, SQLERRM;
# RAISE NOTICE 'ROLLING BACK...';
# ROLLBACK;
# END;
...
# 
# BEGIN
# RAISE NOTICE 'EXECUTING MIGRATION create_core_pg_migrations_execution_migration_table';
...
# EXCEPTION WHEN OTHERS THEN
# RAISE NOTICE 'MIGRATION create_core_pg_migrations_execution_migration_table ERROR';
# RAISE NOTICE 'STATE: %s, ERROR: %s.', SQLSTATE, SQLERRM;
# RAISE NOTICE 'ROLLING BACK...';
# ROLLBACK;
# END;
...
# 
# BEGIN
# RAISE NOTICE 'EXECUTING MIGRATION create_core_pg_migrations_execution_commit_hash_table';
...
# EXCEPTION WHEN OTHERS THEN
# RAISE NOTICE 'MIGRATION create_core_pg_migrations_execution_commit_hash_table ERROR';
# RAISE NOTICE 'STATE: %s, ERROR: %s.', SQLSTATE, SQLERRM;
# RAISE NOTICE 'ROLLING BACK...';
# ROLLBACK;
# END;
...
# 
# BEGIN
# RAISE NOTICE 'EXECUTING MIGRATION create_core_pg_migrations_functions';
# 
...
# 
# EXCEPTION WHEN OTHERS THEN
# RAISE NOTICE 'MIGRATION create_core_pg_migrations_functions ERROR';
# RAISE NOTICE 'STATE: %s, ERROR: %s.', SQLSTATE, SQLERRM;
# RAISE NOTICE 'ROLLING BACK...';
# ROLLBACK;
# END;
