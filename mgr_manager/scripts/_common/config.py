...
import toml
import mgr_manager
# from mgr_manager.backend import\
#     register_types
import functools
import time
...
class _ExecutionConfiguration:
    ...
    def TEMPLATE_PATH(self) -> str:
        return f'{os.path.dirname(mgr_manager.__file__)}/template'
...
class DowngradeConfiguration(ActionConfiguration):
    ...
    def opposite_action(self) -> mgr.schema.execution_action.enum:
        return mgr_manager.execution_action.downgrade
...
class SetupConfiguration(ActionConfiguration):
    def __init__(
        ...
        ActionConfiguration.__init__(self, "mgr_manager", args)
